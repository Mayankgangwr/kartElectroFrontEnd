  ...
  return (
    <main className=" flex justify-between items-center py-1 mb-5  relative">
      <section className="max-w-xl mx-auto sm:mx-0  w-full py-2  lg:w-1/3">
        <h1 className="text-6xl  sm:text-7xl lg:text-8xl font-semibold  py-3 w-full" style={{ fontSize: "5rem", lineHeight: "1.2" }}>
          Camera & Speeker
        </h1>
      ...
      <section className="hidden w-1/2 lg:flex justify-end">
        <img src={'./assets/bannerImg.png'} alt="bannerImg" className="w-2/3 h-full" />
      </section>
    </main>
  );
};
